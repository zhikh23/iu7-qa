...
\begin{definition}[Непрерывность функции на интервале] \label{def:54}
...
\begin{definition}[Невозрастающая функция на интервале] \label{def:69}
...
\begin{definition}[Неубывающая функция на интервале] \label{def:71}
...
\begin{definition}[Точка строгого локального минимума] \label{def:74}
...
\begin{definition}[Точка строгого локального максимума] \label{def:75}
...
\begin{definition}[Точка локального минимума] \label{def:76}
...
\begin{definition}[Стационарные точки] \label{def:81}
    Точки, в которых производная функции обращается в ноль называются \textit{стационарными}.
\end{definition}


\begin{definition}[Точка локального максимума] \label{def:77}
...
\begin{definition}[Выпуклость вверх] \label{def:86}
...
\begin{definition}[Выпуклость вниз] \label{def:87}
...
\begin{definition}[Точка перегиба функции] \label{def:88}
